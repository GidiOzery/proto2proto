            ...
            if dir_for_saving_prototypes is not None:
                if prototype_self_act_filename_prefix is not None:
                    ...
                    np.save(os.path.join(dir_for_saving_prototypes,
                                         "%05d_" % j + prototype_self_act_filename_prefix + '.npy'),
                            proto_act_img_j)
                if prototype_img_filename_prefix is not None:
                    # save the whole image containing the prototype as png
                    plt.imsave(os.path.join(dir_for_saving_prototypes,
                                            "%05d_" % j + prototype_img_filename_prefix + '-original' + '.png'),
...
#                     plt.imsave(os.path.join(dir_for_saving_prototypes,
#                                             "%05d_" % j + prototype_img_filename_prefix + '-original_with_self_act' + '.png'),
...
#                         plt.imsave(os.path.join(dir_for_saving_prototypes,
#                                                 "%05d_" % j + prototype_img_filename_prefix + '-receptive_field' + '.png'),
#                                    rf_img_j,
#                                    vmin=0.0,
#                                    vmax=1.0)
                        overlayed_rf_img_j = overlayed_original_img_j[rf_prototype_j[1]:rf_prototype_j[2],
                                                                      rf_prototype_j[3]:rf_prototype_j[4]]
#                         plt.imsave(os.path.join(dir_for_saving_prototypes,
#                                                 "%05d_" % j + prototype_img_filename_prefix + '-receptive_field_with_self_act' + '.png'),
#                                    overlayed_rf_img_j,
#                                    vmin=0.0,
#                                    vmax=1.0)
                    ...
                    plt.imsave(os.path.join(dir_for_saving_prototypes,
                                            "%05d_" % j + prototype_img_filename_prefix + '.png'),
                               proto_img_j,
                               vmin=0.0,
                               vmax=1.0)
